...
import (
	...
	"github.com/xformation/xformation/pkg/tsdb"
	"github.com/xformation/xformation/pkg/tsdb/testdata"
...
func GetTestDataRandomWalk(c *middleware.Context) Response {
	...
	dsInfo := &models.DataSource{Type: "xformation-testdata-datasource"}
	request.Queries = append(request.Queries, &tsdb.Query{
		RefId:      "A",
