...
func sendUsageStats() {
	...
	metricsLogger.Debug("Sending anonymous usage stats to stats.xformation.org")
	...
	go client.Post("https://stats.xformation.org/xformation-usage-report", "application/json", data)
}
