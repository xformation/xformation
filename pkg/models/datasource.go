...
import (
	...
	"github.com/xformation/xformation/pkg/components/securejsondata"
...
var knownDatasourcePlugins map[string]bool = map[string]bool{
	...
	"newrelic-app":                        true,
	"xformation-datadog-datasource":          true,
	"xformation-simple-json":                 true,
	"xformation-splunk-datasource":           true,
	"udoprog-heroic-datasource":           true,
	"xformation-openfalcon-datasource":       true,
