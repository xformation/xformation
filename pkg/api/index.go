...
func setIndexViewData(c *middleware.Context) (*dtos.IndexViewData, error) {
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		...
		Children: []*dtos.NavLink{
			...
			{Text: "Community site", Url: "http://community.xformation.com", Icon: "fa fa-fw fa-comment", Target: "_blank"},
			{Text: "Documentation", Url: "http://docs.xformation.org", Icon: "fa fa-fw fa-file", Target: "_blank"},
		},
	})
